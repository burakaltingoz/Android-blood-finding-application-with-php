            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Hastane
...
<div class="col-lg-6">
                            ...
                            <table class="table table-bordered table-hover table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Adres</th>
                                        <th>Telefon</th>
										<th colspan="2">Ä°ÅŸlemler</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
	include "baglan.php";
    // tüm kayýtlar veritabanýndan çekiliyor
    $sonuc=mysql_query("select * from hastane");
    ...
    echo "<td>".$kayit['ad']."</td>";
    echo "<td>".$kayit['en']."</td>";
    echo "<td>".$kayit['boy']."</td>";
	echo "<td><a href='hastane_sil.php?id=".$kayit['id']."'>Sil</a></td>";
    echo "<td><a href='hastane_duzenle.php'>DÃ¼zenle</a></td>";
	echo "</tr>";
	}
